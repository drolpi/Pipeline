...
import de.natrox.pipeline.datatype.connection.ConnectionDataLoader;

import java.util.UUID;

public class ConnectionDataLoaderTest {

    private final ConnectionDataLoader connectionDataLoader;

    public ConnectionDataLoaderTest(Pipeline pipeline) {
